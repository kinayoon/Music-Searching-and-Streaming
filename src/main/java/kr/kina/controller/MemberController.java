...
public class MemberController {
	 ...
	 * */
	@RequestMapping(value="/myMusic", method=RequestMethod.POST, consumes="application/json; charset=UTF-8")
	public void myMusicPOST(HttpSession session, RedirectAttributes attr) throws Exception{

		String userid = (String) session.getAttribute("id");
		favoriteService.deleteFavoriteSong(userid);
	}
}
